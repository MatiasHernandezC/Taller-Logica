...
Radiobutton(frame, text="Poco", bg="deep sky blue", font=("Comic Sans MS", 15), variable=cantidadSF, value=0).grid(row=1, column=0, pady = 10, padx = 25)
...
Radiobutton(frame, text="Mucho", bg="deep sky blue", font=("Comic Sans MS", 15), variable=cantidadSF, value=2).grid(row=3, column=0, pady = 10, padx = 25)

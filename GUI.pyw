...
def abrirNuevaVentana():
    ...
    ruta_ventana = os.path.join(os.path.dirname(__file__), "src/nueva_ventana.pyw")
...
## Título
miTitulo = Label(frame, text="Test de Salud Mental", fg="red", font=("Comic Sans MS", 20))
miTitulo.grid(row=0, column=1, pady=30, padx=50)

## Botón Empezar test
botonAbrir = Button(frame, text="Comenzar test", font=("Comic Sans MS", 14), bg="SpringGreen2", relief=GROOVE, command=salirAplicacion)
